...
const page = () => {
    return (
      <div className="text-white p-[24px]">
        <h1 className=" text-[28px] font-medium">Terms & Conditions</h1>
        <h2 className="text-[16px] font-normal mb-4">
          Last updated on 24/12/2024
        </h2>
        <hr className="border mb-3 border-[#C6C6C6]" />
        <p className="text-[#C6C6C6] mb-3 font-normal">
          These terms and conditions applies to the 360Trader app (hereby
          referred to as &quot;Application&quot;) for mobile devices that was
          created by 360Trader LLC. (hereby referred to as &quot;Service
          Provider&quot;) as a Commercial service.
        </p>
        <p className="text-[#C6C6C6] mb-3 font-normal">
        ...
        <h2 className="text-[16px] font-medium mb-3">Google Play Services</h2>
        <p className="text-[#C6C6C6] mb-3 font-normal">
        ...
        <h2 className="text-[16px] font-medium mb-3">Contact Us</h2>
        <p className="text-[#C6C6C6] mb-3 font-normal">
          If you have any questions or suggestions about the Terms and
          Conditions, please do not hesitate to contact the Service Provider at
          <span className="text-[#007CBA]"> admin@boom360trader.com</span>.
        </p>
        <p className="text-[#C6C6C6] mb-3 font-normal">
